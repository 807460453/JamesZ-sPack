<template>
  <div>
    <DynamicForm
      ...
      label-width="100px"
    >
      <template #start_form="{ ctx }"> start_form:{{ ctx.test }} </template>
      <template #after_f4_slot> after_f4_slot </template>
    ...
    initCmps() {
      ...
      this.cmpItems = [
        ...
        },
        {
          ...
          cmp: {
            type: "el-radio-group",
            subComps: [{ key: 1, label: "1", content: "111radio" }],
          },
        },
      ];
    },
